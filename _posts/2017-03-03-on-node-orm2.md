...
1. After closing one database connection is it impossible to create a new connection. Want to create a new DB connection in each of your tests? Too bad, you can't, instead you have to come up with a convoluted way of sharing a single database connection across tests.
